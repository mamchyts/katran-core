<?php
/**
 * The file contains class FileAPI()
 */
...
class FileAPI {
    ...
    /**
     * [rRestructuringFilesArray description]
     * @param  [type] &$arrayForFill        [description]
     * @param  [type] $currentKey           [description]
     * @param  [type] $currentMixedValue    [description]
     * @param  [type] $fileDescriptionParam [description]
